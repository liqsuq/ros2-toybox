...
: Node("ping_pub", opts) {
  ...
  timer_ = this->create_wall_timer(
    1s, std::bind(&pingpong::PingPubNode::callback, this));
}

void pingpong::PingPubNode::callback() {
...
: Node("ping_sub", opts) {
  ...
  sub_ = this->create_subscription<pingpong::msg::Pong>(
    "pong", 10, std::bind(&pingpong::PingSubNode::callback, this, _1));
}

void pingpong::PingSubNode::callback(const pingpong::msg::Pong::SharedPtr msg) {
