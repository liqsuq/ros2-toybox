...
rclcpp::Publisher<pingpong_interfaces::msg::Pong>::SharedPtr
  publisher = nullptr;
pingpong_interfaces::msg::Pong message;

struct timespec time1 = {0, 0};
struct timespec time2 = {0, 0};

void callback(const pingpong_interfaces::msg::Ping::SharedPtr msg) {
...
int main(int argc, char **argv) {
  ...
  // pong publisher
  publisher = node->
    create_publisher<pingpong_interfaces::msg::Pong>("pong", 10);

  // ping subscriber
  auto subscription = node->
    create_subscription<pingpong_interfaces::msg::Ping>("ping", 10, callback);
